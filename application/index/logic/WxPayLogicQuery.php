    ...
    public function alpay($params = null)
    {
        try {
            ...
            $wap_config = [
                ...
                'notify_url' => 'http://www.dongdaika.com/index/wxpay/alnotify',
                //跳转通知url
                'return_url' => 'http://www.dongdaika.com/index/index/detail?cop=' . base64_encode(base64_encode($params['cid']))
            ];
            ...
            $parameter = array(
                ...
                "subject" => '机构分析查询',//订单名称
                "total_fee" => $params['price'] / 100,//付款金额
